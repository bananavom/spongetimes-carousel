...
스킬 문서는 Claude가 읽는 명세라 사람이 읽기엔 길다. 유닛원은 아래 한 장짜리 안내서부터 본다 —
요일별로 무슨 말을 던지면 되는지, **소재 하나를 가설 문장으로 바꾸는 법**, 노리는 반응별 훅 선택,
현재 기준선 숫자가 정리돼 있다.

👉 **[가설 검증 사용법](https://claude.ai/code/artifact/df31f979-867b-403b-bb99-46025325883d)**
