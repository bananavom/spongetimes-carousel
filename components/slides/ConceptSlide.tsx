...
export function ConceptSlide({ draft }: { draft: CarouselDraft }) {
  return (
    <div style={{ width: 1080, height: 1350, background: COLORS.bodyBg, position: 'relative', overflow: 'hidden', fontFamily: "'Pretendard', 'Noto Sans KR', sans-serif" }}>
      ...
      <div style={{ position: 'absolute', top: 420, left: '50%', transform: 'translateX(-50%)', background: COLORS.accent, color: '#fff', padding: '24px 60px', borderRadius: 24, fontSize: 80, fontWeight: 800, letterSpacing: '-0.02em' }}>
