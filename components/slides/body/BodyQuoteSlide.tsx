...
export function BodyQuoteContent({ slide, highlightColor }: { slide: BodySlide; highlightColor?: string }) {
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
      <div style={{ fontSize: px(23), fontWeight: 700, lineHeight: 1.4, letterSpacing: '-0.015em', whiteSpace: 'pre-line' }}>
        ...
        <Highlighted text={text} highlight={emphasis.on ? emphasis.text : ''} fontSize={px(23)} color={highlightColor} />
      </div>
